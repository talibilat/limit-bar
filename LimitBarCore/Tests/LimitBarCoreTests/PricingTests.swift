...
struct PricingTests {
    ...
    func selectsLatestEffectivePricingAtUsageTime() throws {
        ...
        let table = PricingTable(entries: [
            price(input: decimal("3.00"), output: decimal("1.00"), effectiveAt: try date(2026, 1, 1)),
            price(input: decimal("4.00"), output: decimal("1.00"), effectiveAt: try date(2026, 7, 1)),
            price(input: decimal("5.00"), output: decimal("1.00"), effectiveAt: try date(2026, 8, 1))
        ])
