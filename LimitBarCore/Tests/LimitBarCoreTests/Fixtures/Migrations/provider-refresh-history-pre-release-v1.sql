...
(1, 1, 'anthropic_api', 'usage_and_cost', 'success', 1784059200.0, '1_to_5_seconds'),
(2, 1, 'openai_api', 'usage_and_cost', 'partial_failure', 1784062800.0, '5_to_30_seconds');

INSERT INTO provider_refresh_windows VALUES
(1, 0, 'today', 1783987200.0, 1784073600.0, 'localCalendar', 1),
(1, 1, 'currentWeek', 1783900800.0, 1784505600.0, 'utcBilling', 2),
(2, 0, 'today', 1783987200.0, 1784073600.0, 'localCalendar', 1);
